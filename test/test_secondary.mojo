...
from slotmap import DefaultKey, SecondaryMap, SlotMap
...
def test_drops() raises:
    ...
    var sm = SlotMap[Int]()
    var sec = SecondaryMap[DropCounter]()
    var keys = List[DefaultKey]()
    for i in range(100):
        keys.append(sm.insert(i))
